				...
				<div class="row-fluid">
					<div class="span4">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="input-xlarge" id="userid" onChange="id_change(this.value)" name="userId">
									<option>请选择</option>
					...
					<div class="span4">
						<legend class=""><h3>我看过的电影.</h3></legend>
						<div id="movies_watched">
							<jsp:include page="movies_watched.jsp"></jsp:include>
						</div>
					</div>
